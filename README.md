...
>- `Table S2` containing the replicate level data now includes additional measurement parameters, such as the cell temperature and electronics temperature
>- `scale_reference.py` now includes an option to use the ∆'<sup>17</sup>O values from Chaillot et al. (2022) instead of Wostbrock et al. (2020) as the accepted reference values for CO<sub>2</sub> generated by acid digestion of IAEA-603 and NBS-18, used to scale light and heavy CO<sub>2</sub> to the VSMOW scale.
